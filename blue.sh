...
# L1_Acc-S17
fvctl -n add-flowspace bfs1 0000000000000041 1 in_port=1,nw_src=10.0.0.69,nw_dst=10.0.0.65 blue=7
...
fvctl -n add-flowspace bfs5 0000000000000041 1 in_port=5,nw_src=10.0.0.65,nw_dst=10.0.0.69 blue=7
...
# fvctl -n add-flowspace bfs8 0000000000000041 1 in_port=8 blue=7 #h68
# L1_Acc-S18
fvctl -n add-flowspace bfs9 0000000000000042 1 in_port=1,nw_src=10.0.0.65,nw_dst=10.0.0.69 blue=7
...
fvctl -n add-flowspace bfs13 0000000000000042 1 in_port=5,nw_src=10.0.0.69,nw_dst=10.0.0.65 blue=7
...
# L2_Agg-S17
fvctl -n add-flowspace bfs33 0000000000000021 1 in_port=5 blue=7 #L1_Acc-S17-eth1
...
# fvctl -n add-flowspace bfs35 0000000000000021 1 in_port=7,nw_src=10.0.0.73 blue=7
# fvctl -n add-flowspace bfs35 0000000000000021 1 in_port=7,nw_src=10.0.0.74 blue=7
# fvctl -n add-flowspace bfs35 0000000000000021 1 in_port=7,nw_src=10.0.0.75 blue=7
# fvctl -n add-flowspace bfs35 0000000000000021 1 in_port=7,nw_src=10.0.0.76 blue=7
# fvctl -n add-flowspace bfs36 0000000000000021 1 in_port=8,nw_src=10.0.0.77 blue=7
