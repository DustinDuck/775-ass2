...
fvctl -n add-flowspace pfs1 31 1 in_port=7,nw_src=10.0.0.15,nw_dst=10.0.0.16 purple=7
fvctl -n add-flowspace pfs2 31 1 in_port=8,nw_src=10.0.0.16,nw_dst=10.0.0.15 purple=7
