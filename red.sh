...
fvctl -n add-flowspace rfs98 000000000000000d 1 in_port=1 red=7
fvctl -n add-flowspace rfs99 000000000000000d 1 in_port=2 red=7
fvctl -n add-flowspace rfs98 000000000000000d 1 in_port=3 red=7
fvctl -n add-flowspace rfs99 000000000000000d 1 in_port=4 red=7
fvctl -n add-flowspace rfs98 000000000000000d 1 in_port=5 red=7
fvctl -n add-flowspace rfs99 000000000000000d 1 in_port=6 red=7
fvctl -n add-flowspace rfs98 000000000000000d 1 in_port=7 red=7
fvctl -n add-flowspace rfs99 000000000000000d 1 in_port=8 red=7
